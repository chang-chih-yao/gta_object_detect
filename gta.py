...
detector.setModelPath("hardhat\models\detection_model-ex-018--loss-0008.717.h5")
...
while(True):
    ...
    detectedImage, detections = detector.detectObjectsFromImage(output_type="array", input_image='output.jpg', minimum_percentage_probability=50)
    #convertedImage = cv2.cvtColor(detectedImage, cv2.COLOR_RGB2BGR)

    for eachObject in detections:
        print(eachObject["name"] , " : ", eachObject["percentage_probability"], " : ", eachObject["box_points"] )

    cv2.imshow('Output', detectedImage)
