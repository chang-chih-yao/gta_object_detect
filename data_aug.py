...
def change_xml_annotation(root, image_id, new_target):
    ...
    # xmlroot.find('filename').text = str(image_id) + "_aug.jpg"
    # print(str(image_id) + "_aug.jpg")
...
def change_xml_list_annotation(root, image_id, new_target,saveroot,id):
    ...
    xmlroot = tree.getroot()
    index = 0
    xmlroot.find('filename').text = str(image_id) + "_aug_" + str(id) + ".jpg"
    # print(str(image_id) + "_aug_" + str(id) + ".jpg")
